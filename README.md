# Multimodal Embedding Similarity Module

This Python module computes similarity between two files of the same modality, such as images, texts, or audio. It leverages pretrained models to extract embeddings and uses cosine similarity to determine how similar the inputs are.
